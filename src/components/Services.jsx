...
function ServiceCard({ service }) {
  ...
  return (
    <div
      className="group relative rounded-sm border border-border bg-bg-card p-8 transition-all duration-300 ease-in-out hover:-translate-y-2 hover:border-accent/60 hover:shadow-[0_20px_40px_-24px_rgba(255,212,0,0.5)]"
    >
